...
interface FilterModalProps {
  ...
  defaultShouldSkipNotifications?: boolean;
...
export const FilterModal: React.FC<FilterModalProps> = ({
  ...
  defaultShouldSkipNotifications,
  ...
  const [shouldSkipNotifications, setShouldSkipNotifications] = useState(defaultShouldSkipNotifications ?? false);
      ...
      <Dialog customContent description={description} hideCloseButton onClose={closeModal} open title={title}>
        <FilterDetailsContainer>
          ...
          <FilterActions
            ...
            setShouldSkipNotifications={setShouldSkipNotifications}
            shouldORFilters={shouldORFilters}
            shouldSkipNotifications={shouldSkipNotifications}
          />
        </FilterDetailsContainer>
        {error && (
