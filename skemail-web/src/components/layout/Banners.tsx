...
import QuickAliasWarningBanner from '../banners/QuickAliasWarningBanner';
...
const Banners = () => {
  ...
  // When the delinquency banner is open, we hide other banners,
  // except for the Quick Alias Warning banner if applicable
  ...
  return (
    <>
      ...
      />
      <QuickAliasWarningBanner openPlansTab={openPlansTab} />
    </>
  );
};
