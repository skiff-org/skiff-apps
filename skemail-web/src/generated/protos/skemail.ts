...
import type {
  SkemailClient as _com_skiff_skemail_grpc_SkemailClient,
  SkemailDefinition as _com_skiff_skemail_grpc_SkemailDefinition
} from './com/skiff/skemail/grpc/Skemail';
    ...
    skiff: {
      ...
      skemail: {
        grpc: {
          ...
          Skemail: SubtypeConstructor<typeof grpc.Client, _com_skiff_skemail_grpc_SkemailClient> & {
            service: _com_skiff_skemail_grpc_SkemailDefinition;
          };
