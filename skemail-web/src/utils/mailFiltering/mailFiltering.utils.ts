...
import { SystemLabelToThreadIDs, UserLabelIDToThreadIDs, requireCurrentUserData } from 'skiff-front-utils';
...
const isLabelSystemLabel = (label: string): label is SystemLabels =>
 ...
 */
const applyUserLabelsToThreads = (labelToThreadIDs: UserLabelIDToThreadIDs) =>
 ...
 */
const applySystemLabelsToThreads = (systemLabelToThreadIDs: SystemLabelToThreadIDs) =>
