      ...
      <AttachmentsList>
        {!attachmentSizeExceeded &&
          filteredAttachments.map((attachment, index) => {
            ...
            const isPgpAttachment = isPgpFile(attachment.contentType, attachment.name);
            const attachmentColor = isPgpAttachment ? 'green' : 'link';
            return (
              <CombinedActionContainer key={attachment.id}>
                ...
                >
                  <Dropshadow>
                    <Icons
                      color={attachmentFailed ? 'destructive' : attachmentColor}
                      icon={
                        attachmentFailed
                          ? Icon.Warning
                          : isPgpAttachment
                          ? Icon.Key
                          : getIconFromMIMEType(attachment.contentType)
                      }
                      size={Size.MEDIUM}
                    />
                  </Dropshadow>
