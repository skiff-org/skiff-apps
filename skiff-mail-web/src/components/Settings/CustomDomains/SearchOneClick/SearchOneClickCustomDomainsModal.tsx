...
const SearchOneClickCustomDomainsModal: React.FC<SearchOneClickCustomDomainsProps> = ({ open, onClose }) => {
  ...
  return (
    <Dialog customContent hideCloseButton={isMobile} onClose={onClose} open={open} size='full-screen'>
      <Wrapper>
        <Container>
          <Header>
          ...
          <LeftContents>
            ...
            <SearchButtons>
              {isMobile && (
                <Button fullWidth onClick={() => setSearchQuery(searchInput)} type={Type.PRIMARY}>
                  Search
                </Button>
              )}
