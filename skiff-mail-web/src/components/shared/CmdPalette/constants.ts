...
export const CMD_LIST_MARGIN = 10;
...
export const TITLE_ONLY_ROW_HEIGHT = 56;

// padding of search header
export const SEARCH_HEADER_PADDING = 12;

// height of search header
export const SEARCH_HEADER_HEIGHT = 32;

// height of a content search result row
export const SKEMAIL_ROW_HEIGHT = 56;
...
export const NO_RESULTS_ROW_HEIGHT = 56;

// height of command palette (display 2 headers + 6 rows by default)
export const CMD_PALETTE_MAX_HEIGHT = 6 * TITLE_ONLY_ROW_HEIGHT;
...
// default search result Typography size
export const SEARCH_ITEM_DEFAULT_TYPOGRAPHY_SIZE = TypographySize.SMALL;

// maximum number of quick actions shown before clicking 'View all'
export const MAX_QUICK_ACTIONS_SHOWN = 30;
