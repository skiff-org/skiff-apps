...
// @ts-expect-error Issue with styled-components and typescript in current versions for importing DISPLAY_SCROLLBAR_CSS
...
export const CommandList = ({
  ...
  const onSearchResultSelect = useCallback(
    ...
    [dispatch, goToFullViewSearch, navigateToSkemailResult, onClose, searchQuery, searchResults]
  );
