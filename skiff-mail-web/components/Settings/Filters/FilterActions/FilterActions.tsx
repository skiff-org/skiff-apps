...
import { LABEL_DROPDOWN_CONTAINER_WIDTH } from '../../../labels/LabelDropdownContent';
  ...
  return (
    <>
      ...
      <SelectLabelDropdown
        ...
        userAnchor={getRightAlignedDropdownAnchor(labelButtonRef, LABEL_DROPDOWN_CONTAINER_WIDTH)}
      />
      ...
      <SelectLabelDropdown
        ...
        userAnchor={getRightAlignedDropdownAnchor(moveToButtonRef, LABEL_DROPDOWN_CONTAINER_WIDTH)}
