...
import { CHIP_END_ICON_DATA_TEST } from '@skiff-org/skiff-ui';
...
import { AttachmentsDataTest } from '../components/Attachments/Attachments';
import Compose, { ComposeDataTest } from '../components/Compose/Compose';
import * as useCurrentLabel from '../hooks/useCurrentLabel';
import { initialSkemailDraftsState, skemailDraftsReducer } from '../redux/reducers/draftsReducer';
import { initialSkemailDialogState, PopulateComposeContent, skemailModalReducer } from '../redux/reducers/modalReducer';
...
jest.mock('../hooks/useUserSignature', () => ({
...
jest.mock('skiff-front-utils', () => {
  ...
  return {
    ...
    useCurrentUserEmailAliases: () => ['alias@skiff.com'],
...
jest.mock('../components/Settings/useSettings', () => ({
  useSettings: () => jest.fn()
}));
