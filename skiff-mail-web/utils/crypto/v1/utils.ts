...
import { AdditionalContext, PermissionLevel, PublicKey, SignatureContext } from '../../../generated/graphql';
import { Datagram, TypedBytes } from './lib/aead/common';
import TaggedSecretBox from './lib/aead/secretbox';
import { utf8BytesToString, utf8StringToBytes } from './lib/utf8';
...
export function encryptSymmetric<T>(content: T, symmetricKey: string, datagram: Datagram<T>): string {
  return encodeBase64(rawEncryptSymmetric(content, symmetricKey, datagram));
}
